...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MENOR_OU_IGUAL = 15,            /* MENOR_OU_IGUAL  */
  YYSYMBOL_MAIOR_QUESimbolo = 16,          /* MAIOR_QUESimbolo  */
  YYSYMBOL_THEN = 17,                      /* THEN  */
  YYSYMBOL_WHILE = 18,                     /* WHILE  */
  YYSYMBOL_MAIOR_OU_IGUAL = 19,            /* MAIOR_OU_IGUAL  */
  ...
  YYSYMBOL_MULTI = 34,                     /* MULTI  */
  YYSYMBOL_ABRE_CHAVE = 35,                /* ABRE_CHAVE  */
  YYSYMBOL_FECHA_CHAVE = 36,               /* FECHA_CHAVE  */
  YYSYMBOL_ABRE_COLCHETE = 37,             /* ABRE_COLCHETE  */
  YYSYMBOL_FECHA_COLCHETE = 38,            /* FECHA_COLCHETE  */
  YYSYMBOL_NUMERO = 39,                    /* NUMERO  */
  YYSYMBOL_DIVISAO = 40,                   /* DIVISAO  */
...
static const yytype_int8 yyrline[] =
{
      ...
      60,    61,    64,    67,    64,    78,    90,    97,   105,   106,
     110,   112
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MENOR_OU_IGUAL", "MAIOR_QUESimbolo", "THEN", "WHILE", "MAIOR_OU_IGUAL",
  "MAIS", "ARRAY", "TYPE", "LABEL", "PROCEDURE", "GOTO", "IF", "ELSE",
  "DO", "OR", "DIV", "AND", "NOT", "MENOS", "MULTI", "ABRE_CHAVE",
  "FECHA_CHAVE", "ABRE_COLCHETE", "FECHA_COLCHETE", "NUMERO", "DIVISAO",
  "READ", "WRITE", "TRUE", "FALSE", "OF", "FUNCTION", "$accept",
...
{
       0,    48,    49,     0,     3,    13,     4,    13,    61,     5,
       6,     7,    13,    50,    52,    53,    54,     9,    51,    12,
      10,    62,    55,    56,    57,    63,    56,    13,    60,    11,
       6,     8,    13,    13,    59,    58,     7
};
...
#line 1193 "compilador.tab.c"
  ...
  case 14: /* declara_var: $@4 lista_id_var DOIS_PONTOS tipo $@5 PONTO_E_VIRGULA  */
